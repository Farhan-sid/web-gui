...
function _wseeAddWidget() {
    var q = document.querySelectorAll('input[type="search"]:not([name="q"]),[name="q"]');
...
documentReady(function(){
    ...
    _wseeSearchByPhotoOption.classList.add(window._wsee_impresee_photo_class);
    _wseeSearchByPhotoOption.classList.add('search-by-photo');
    ...
    _wseeSearchBySketchOption.classList.add(window._wsee_impresee_sketch_class);
    _wseeSearchBySketchOption.classList.add('search-by-sketch');
